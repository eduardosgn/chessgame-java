...
public class King extends ChessPiece {
    ...
    public boolean[][] possibleMoves() {
        boolean[][] move = new boolean[getBoard().getRows()][getBoard().getColumns()];
        ...
        if (getBoard().positionExists(p) && canMove(p)) {
            move[p.getRow()][p.getColumn()] = true;
        }
        ...
        if (getMoveCount() == 0 && !chessMatch.getCheck()) {
            // #spencial move castling kingside rook
            ...
            if (testRookCastling(posRook1)) {
                ...
                if (getBoard().piece(p1) == null && getBoard().piece(p2) == null) {
                    move[position.getRow()][position.getColumn() + 2] = true;
                }
            }
